...
//-----------------------------------------------------------------------------
class CMainStatus : public vgui::Frame, public IViewPortPanel
{
	DECLARE_CLASS_SIMPLE( CMainStatus, vgui::Frame );

public:
	CMainStatus( IViewPort *pViewPort );
	virtual ~CMainStatus();

	virtual const char *GetName( void ) { return PANEL_MAINSTATUS; }
