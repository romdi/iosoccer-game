...
void CClientScoreBoardDialog::UpdateTeamInfo()
{
    ...
    for (i=TEAM_UNASSIGNED;i<TEAMS_COUNT;i++)
    {
        ...
        m_pPlayerList->ModifyColumn(sectionId, "redcards", sz);
        swprintf(sz, L"%d", m_TeamYellowCard[i]);
        m_pPlayerList->ModifyColumn(sectionId, "yellowcards", sz);
        swprintf(sz, L"%d", m_TeamFouls[i]);
        m_pPlayerList->ModifyColumn(sectionId, "fouls", sz);
        swprintf(sz, L"%d", m_TeamAssists[i]);
        m_pPlayerList->ModifyColumn(sectionId, "assists", sz);
        swprintf(sz, L"%d", m_TeamPossession[i]);
        m_pPlayerList->ModifyColumn(sectionId, "possession", sz);
        swprintf(sz, L"%d", m_TeamPasses[i]);
        m_pPlayerList->ModifyColumn(sectionId, "passes", sz);
        swprintf(sz, L"%d", m_TeamFreeKicks[i]);
        m_pPlayerList->ModifyColumn(sectionId, "freekicks", sz);
        swprintf(sz, L"%d", m_TeamPenalties[i]);
        m_pPlayerList->ModifyColumn(sectionId, "penalties", sz);
        swprintf(sz, L"%d", m_TeamCorners[i]);
        m_pPlayerList->ModifyColumn(sectionId, "corners", sz);
        swprintf(sz, L"%d", m_TeamThrowIns[i]);
        m_pPlayerList->ModifyColumn(sectionId, "throws", sz);
        swprintf(sz, L"%d", m_TeamKeeperSaves[i]);
        m_pPlayerList->ModifyColumn(sectionId, "saves", sz);
        swprintf(sz, L"%d", m_TeamGoalKicks[i]);
        m_pPlayerList->ModifyColumn(sectionId, "goalkicks", sz);
...
void CClientScoreBoardDialog::AddHeader()
{
    ...
    m_pPlayerList->AddSection(m_iSectionId, "");
    m_pPlayerList->SetSectionAlwaysVisible(m_iSectionId);
    m_pPlayerList->AddColumnToSection(m_iSectionId, "position",		"Pos", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "name",			"Player", 0, scheme()->GetProportionalScaledValue(NAME_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "frags",		"Goals", 0, scheme()->GetProportionalScaledValue(SMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "assists",		"Assists", 0, scheme()->GetProportionalScaledValue(SMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "possession",	"%", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "redcards",		"Red", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "yellowcards",	"Yel", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "fouls",		"Foul", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
	m_pPlayerList->AddColumnToSection(m_iSectionId, "passes",		"Pass", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "freekicks",	"FKs", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "penalties",	"Pen", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "corners",		"Cnr", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "throws",		"Thr", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "saves",		"Sav", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "goalkicks",	"GKs", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    m_pPlayerList->AddColumnToSection(m_iSectionId, "ping",			"ping", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    ...
    iTeamSections[TEAM_A]  = AddSection(TYPE_TEAM, TEAM_A);
    iTeamSections[TEAM_B]   = AddSection(TYPE_TEAM, TEAM_B);
...
int CClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
    ...
    if ( teamType == TYPE_TEAM )
    {
		...
		m_pPlayerList->AddColumnToSection(m_iSectionId, "position",		"", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
        m_pPlayerList->AddColumnToSection(m_iSectionId, "name",			teamName, 0, scheme()->GetProportionalScaledValue(NAME_WIDTH) );
        m_pPlayerList->AddColumnToSection(m_iSectionId, "frags",		"0", 0, scheme()->GetProportionalScaledValue(SMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "assists",		"0", 0, scheme()->GetProportionalScaledValue(SMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "possession",	"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "redcards",		"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "yellowcards",	"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "fouls",		"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "passes",		"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "freekicks",	"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "penalties",	"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "corners",		"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "throws",		"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "saves",		"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "goalkicks",	"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
		m_pPlayerList->AddColumnToSection(m_iSectionId, "ping",			"0", 0, scheme()->GetProportionalScaledValue(VSMALL_WIDTH) );
    ...
    else if ( teamType == TYPE_SPECTATORS )
    {
        ...
        m_pPlayerList->AddColumnToSection(m_iSectionId, "frags", "", 0, scheme()->GetProportionalScaledValue(SMALL_WIDTH) );
        m_pPlayerList->AddColumnToSection(m_iSectionId, "ping", "", 0, scheme()->GetProportionalScaledValue(SMALL_WIDTH) );
    }
...
bool CClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex, KeyValues *kv)
{
	...
	kv->SetInt("frags", gr->GetGoals( playerIndex ) );
