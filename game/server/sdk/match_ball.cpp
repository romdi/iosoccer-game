...
ConVar
	...
	sv_ball_statetransition_postmessagedelay_normal			("sv_ball_statetransition_postmessagedelay_normal",			"1",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_statetransition_postmessagedelay_long			("sv_ball_statetransition_postmessagedelay_long",			"2",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_statetransition_messagedelay_normal				("sv_ball_statetransition_messagedelay_normal",				"0.1",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	...
	sv_ball_yellowcardballdist_forward						("sv_ball_yellowcardballdist_forward",						"60",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_yellowcardballdist_backward						("sv_ball_yellowcardballdist_backward",						"60",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	...
	sv_ball_stats_pass_mindist								("sv_ball_stats_pass_mindist",								"200",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_stats_clearance_minspeed						("sv_ball_stats_clearance_minspeed",						"800",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_stats_shot_mindist								("sv_ball_stats_shot_mindist",								"200",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_stats_save_minspeed								("sv_ball_stats_save_minspeed",								"800",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_stats_assist_maxtime							("sv_ball_stats_assist_maxtime",							"8",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_advantage_duration_freekick						("sv_ball_advantage_duration_freekick",						"4",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	...
	sv_ball_advantage_duration_penalty						("sv_ball_advantage_duration_penalty",						"2",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_advantage_ignore_duration_penalty				("sv_ball_advantage_ignore_duration_penalty",				"1",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_offsidedist										("sv_ball_offsidedist",										"25",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_goalcelebduration								("sv_ball_goalcelebduration",								"6",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	...
	sv_ball_chargedshotblocktime_freekick					("sv_ball_chargedshotblocktime_freekick",					"0",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_chargedshotblocktime_corner						("sv_ball_chargedshotblocktime_corner",						"0",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_shotsblocktime_penalty							("sv_ball_shotsblocktime_penalty",							"0",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_slidesidereach_foul								("sv_ball_slidesidereach_foul",								"20",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_slideforwardreach_foul							("sv_ball_slideforwardreach_foul",							"40",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_slidebackwardreach_foul							("sv_ball_slidebackwardreach_foul",							"30",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	...
	sv_ball_chargedthrow_minstrength						("sv_ball_chargedthrow_minstrength",						"800",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
	sv_ball_chargedthrow_maxstrength						("sv_ball_chargedthrow_maxstrength",						"1000",		FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY),
