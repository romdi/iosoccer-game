...
public:
   ...
   void  EXPORT PenaltyBoxTouch( CBaseEntity *pOther );
   int   m_iTeam;
	int ObjectCaps( void ) { return CBaseTrigger::ObjectCaps() & ~FCAP_ACROSS_TRANSITION; }
};
...
//
//
void CTriggerPenaltyBox :: KeyValue( KeyValueData *pkvd )
{
...
//
//
void CTriggerPenaltyBox :: Spawn( void )
{
	if (m_flWait == 0)
		m_flWait = 0.2;

	InitTrigger();
   SetTouch( PenaltyBoxTouch );
}

////////////////////////////////////////
//
//
void CTriggerPenaltyBox :: regen( void )
{
   m_flWait = 0.2;
   SetTouch( PenaltyBoxTouch );
...
//
//
void CTriggerPenaltyBox :: PenaltyBoxTouch( CBaseEntity *pOther )
{
	...
	if ( (pevToucher->flags & FL_MONSTER) ) {
      //reduce the team to 0-1 then flip it for penalty
      ((CBall*)pOther)->m_BallInPenaltyBox = !(pev->team-1);  //whos penalty box is it 1 or 2 (-1 means outside box)
      return;
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////
//
// Trigger Ball - generic trigger when ball touches it - trigger sounds etc by ball touch
//
///////////////////////////////////////////////////////////////////////////////////////////////
class CTriggerBall : public CBaseTrigger
{
public:
	void  Spawn( void );
  	void  KeyValue( KeyValueData *pkvd );
...
LINK_ENTITY_TO_CLASS( trigger_ball, CTriggerBall );

////////////////////////////////////////
//
//
void CTriggerBall :: Spawn( void )
{
	if (m_flWait == 0)
		m_flWait = 0.2;
...
//
//
void CTriggerBall :: KeyValue( KeyValueData *pkvd )
{
	if (FStrEq(pkvd->szKeyName, "team"))
	{
		m_iTeam = atoi(pkvd->szValue);
...
//
//
void CTriggerBall :: BallTouch( CBaseEntity *pOther )
{
	entvars_t	*pevToucher;
   ...
   if (pev->nextthink > gpGlobals->time)
	...
	// only the ball will have FL_MONSTER
	if ( (pevToucher->flags & FL_MONSTER) && !((CBall*)pOther)->ballStatus )	{
   
      //trigger map style things
