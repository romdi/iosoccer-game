...
ConVar mp_shield_throwin_radius_teammate("mp_shield_throwin_radius_teammate", "180", FCVAR_NOTIFY | FCVAR_REPLICATED);
ConVar mp_shield_throwin_radius_opponent("mp_shield_throwin_radius_opponent", "360", FCVAR_NOTIFY | FCVAR_REPLICATED);
ConVar mp_shield_freekick_radius_teammate("mp_shield_freekick_radius_teammate", "180", FCVAR_NOTIFY|FCVAR_REPLICATED);
ConVar mp_shield_freekick_radius_opponent("mp_shield_freekick_radius_opponent", "540", FCVAR_NOTIFY|FCVAR_REPLICATED);
ConVar mp_shield_corner_radius_teammate("mp_shield_corner_radius_teammate", "180", FCVAR_NOTIFY|FCVAR_REPLICATED);
ConVar mp_shield_corner_radius_opponent("mp_shield_corner_radius_opponent", "540", FCVAR_NOTIFY|FCVAR_REPLICATED);
ConVar mp_shield_kickoff_radius_teammate("mp_shield_kickoff_radius_teammate", "180", FCVAR_NOTIFY | FCVAR_REPLICATED);
ConVar mp_shield_kickoff_radius_opponent("mp_shield_kickoff_radius_opponent", "360", FCVAR_NOTIFY|FCVAR_REPLICATED);
