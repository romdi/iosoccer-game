...
ConVar mp_divingheader_move_duration("mp_divingheader_move_duration", "1.15", FCVAR_REPLICATED | FCVAR_NOTIFY);
ConVar mp_divingheader_idle_duration("mp_divingheader_idle_duration", "0.15", FCVAR_REPLICATED | FCVAR_NOTIFY);
ConVar mp_divingheaderspeed("mp_divingheaderspeed", "400", FCVAR_REPLICATED | FCVAR_NOTIFY);

ConVar mp_chargedshot_increaseduration("mp_chargedshot_increaseduration", "1.66", FCVAR_REPLICATED | FCVAR_NOTIFY);
...
ConVar mp_chargedshot_idleduration("mp_chargedshot_idleduration", "1.0", FCVAR_REPLICATED | FCVAR_NOTIFY);
...
ConVar mp_player_pressure_enabled("mp_player_pressure_enabled", "1", FCVAR_REPLICATED | FCVAR_NOTIFY);
